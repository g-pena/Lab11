...
class MainClass {
  public static void Main (string[] args) {
    ...
    f1.LastName = "Jorb";
    f1.Employer = "Tri-C";
    f1.DateOfEmployment = Convert.ToDateTime("07/20/1997");
    f1.PermanentAddress.AddressLine1 = "1234 JerbJorb Ln";
    f1.PermanentAddress.City = "Jerb";
    f1.PermanentAddress.State = "OH";
    f1.PermanentAddress.Zipcode = "12345";
    f1.LengthOfEmployment();
    f1.Promote();
    f1.GrantTenure();
    f1.Promote();
    f1.Promote();
